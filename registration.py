...
register(
  task_id="SnakeDiscrete-v2",
  import_path="envpool.box2d",
  spec_cls="SnakeDiscreteEnvSpec",
  dm_cls="SnakeDiscreteDMEnvPool",
  gym_cls="SnakeDiscreteGymEnvPool",
  gymnasium_cls="SnakeDiscreteGymnasiumEnvPool",
  max_episode_steps=2000,
)

register(
  task_id="MultiSnakeDiscrete-v2",
  import_path="envpool.box2d",
  spec_cls="MultiSnakeDiscreteEnvSpec",
  dm_cls="MultiSnakeDiscreteDMEnvPool",
  gym_cls="MultiSnakeDiscreteGymEnvPool",
  gymnasium_cls="MultiSnakeDiscreteGymnasiumEnvPool",
  max_episode_steps=2000,
)