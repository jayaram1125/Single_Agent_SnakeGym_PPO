...
#include "envpool/box2d/snake_discrete.h"
#include "envpool/box2d/multisnake_discrete.h"
...
using SnakeDiscreteEnvSpec = PyEnvSpec<box2d::SnakeDiscreteEnvSpec>;
using SnakeDiscreteEnvPool = PyEnvPool<box2d::SnakeDiscreteEnvPool>;


using MultiSnakeDiscreteEnvSpec = PyEnvSpec<box2d::MultiSnakeDiscreteEnvSpec>;
using MultiSnakeDiscreteEnvPool = PyEnvPool<box2d::MultiSnakeDiscreteEnvPool>;
...
PYBIND11_MODULE(box2d_envpool, m) {
  ...
  REGISTER(m, SnakeDiscreteEnvSpec, SnakeDiscreteEnvPool)
  REGISTER(m, MultiSnakeDiscreteEnvSpec, MultiSnakeDiscreteEnvPool)
}
